...
a = int(input("Informe o valor referente às horas atuais: "))
b = int(input("Informe o valor referente aos minutos atuais: "))

c =  (a + 60) + b

print(f"se passaram desde às 00:00h deste dia {c} minutos")